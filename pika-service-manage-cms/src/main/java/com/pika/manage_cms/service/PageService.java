...
import com.pika.manage_cms.config.RabbitmqConfig;
import com.pika.manage_cms.dao.CmsConfigRepository;
import com.pika.manage_cms.dao.CmsPageRepository;
import com.pika.manage_cms.dao.CmsTemplateRespository;
...
public class PageService {
    ...
    public QueryResponseResult findList(int page, int size, QueryPageRequest queryPageRequest) {
        ...
        Page<CmsPage> all = cmsPageRepository.findAll(example, pageable);//实现自定义条件查询并且分页
    ...
    private void sendPostPage(String pageId) {
        //得到页面信息，为了找到它的站点信息（站点信息是rountingKey）
        CmsPage cmsPage = this.getById(pageId);
        //创建消息对象
        Map<String, String> msg = new HashMap<>();
        msg.put("pageId", pageId);
        //转换成字符串
        Object jsonString = JSON.toJSONString(msg);
        //发送给mq
        //站点Id
     ...
     * 保存html到GridFs
     * @param pageId 页面id
     * @param htmlContent 页面静态化信息
     * @return html文件id更新后的cmsPage
     */
